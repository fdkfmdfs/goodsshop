    ...
    return (
        <nav className="nav">
            <ul className="listWrap">
                <li><NavLink to="/" style={({isActive}) => (isActive ? activeStyle: undefined)}>홈</NavLink></li>
                <li><NavLink to="/interior" style={({isActive}) => (isActive ? activeStyle: undefined)}>인테리어용품</NavLink></li>
